...
public class CategoryActivity extends AppCompatActivity {
    ...
    private void loadData()
    {
        ...
        firestore.collection("VoteApp").document("Categories")
    ...
    private void addNewCategory(final String title)
    {
        ...
        final String doc_id = firestore.collection("VoteApp").document().getId();

        firestore.collection("VoteApp").document(doc_id)
                .set(catData)
