...
import static com.example.vapp.CategoryActivity.catList;
import static com.example.vapp.CategoryActivity.selected_cat_index;
import static com.example.vapp.QuestionsActivity.quesList;
import static com.example.vapp.SetsActivity.selected_set_index;
import static com.example.vapp.SetsActivity.setsIDs;
...
public class QuestionDetailsActivity extends AppCompatActivity {
    ...
    private void addNewQuestion()
    {
        ...
        final String doc_id = firestore.collection("VoteApp").document(catList.get(selected_cat_index).getId())
                .collection(setsIDs.get(selected_set_index)).document().getId();

        firestore.collection("VoteApp").document(catList.get(selected_cat_index).getId())
